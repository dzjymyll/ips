...
def create_tf_example(example):
    ...
    image_path = os.getcwd() + '/Fish_6Types_Final/image/' +  FLAGS.images_dir + example
    labels_path = os.getcwd() + '/Fish_6Types_Final/training_xml/' +  FLAGS.labels_dir + os.path.splitext(example)[0] + '.xml'
